...
import com.stos.concert.hall.domain.Hall;
...
public class Concert {
	...
	public Concert(Long id, String title, String description, String mainImageUrl, List<String> detailImageUrls,
		Hall hall, List<Schedule> schedules, LocalDateTime reservableStartDateTime, LocalDateTime reservableEndDateTime,
		long hit) {
		this.id = id;
		this.title = title;
