package com.stos.concert.entity;

import com.stos.schedule.entity.Schedule;
import com.stos.hall.entity.Hall;
...
public class Concert {
    ...
    public Concert(Long id, String title, String description, String mainImageUrl, List<String> detailImageUrls, Hall hall, List<Schedule> schedules, LocalDateTime reservableStartDateTime, LocalDateTime reservableEndDateTime, long hit) {
        this.id = id;
        this.title = title;
    ...
    private LocalDate getConcertLastDate(){
        return schedules.stream()
                .max(Comparator.comparing(Schedule::getStartDateTime))
                .map(Schedule::getStartDateTime)
                .get()
                .toLocalDate();
    }
